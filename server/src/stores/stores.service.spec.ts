...
describe('StoresService', () => {
  ...
  describe('findAll', () => {
    it('should return an array of stores', async () => {
      ...
      mockDb.from.mockResolvedValue(stores);
  ...
  describe('findOne', () => {
    it('should return a store by id', async () => {
      mockDb.where.mockResolvedValue([mockStore]);
  ...
  describe('create', () => {
    ...
    it('should create and return a new store', async () => {
      ...
      mockDb.returning.mockResolvedValue([newStore]);
  ...
  describe('update', () => {
    ...
    it('should update and return the store', async () => {
      ...
      mockDb.where.mockResolvedValueOnce([mockStore]); // findOne call
      mockDb.returning.mockResolvedValue([updatedStore]);
