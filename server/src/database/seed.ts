...
import { drizzleClient } from "./database.provider";
  ...
  const insertedStores = await db
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        address: sql.raw(`excluded.${stores.address.name}`),
        phone: sql.raw(`excluded.${stores.phone.name}`),
      },
    })
    .returning();
  ...
  await db
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        category: sql.raw(`excluded.${products.category.name}`),
        price: sql.raw(`excluded.${products.price.name}`),
        quantity: sql.raw(`excluded.${products.quantity.name}`),
        description: sql.raw(`excluded.${products.description.name}`),
        storeId: sql.raw(`excluded.${products.storeId.name}`),
      },
    });
