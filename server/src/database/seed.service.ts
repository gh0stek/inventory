...
export class SeedService implements OnModuleInit {
  ...
  constructor(@Inject(DRIZZLE) private readonly db: DrizzleProvider) {}
  ...
  async seed() {
    ...
    const electronicsProducts: Omit<NewProduct, "storeId">[] = [
      ...
      },
      {
        ...
        quantity: 33,
        sku: "ELEC-RVD4",
        description: "Smart video doorbell with 1080p",
      },
      {
      ...
      },
      {
        ...
        quantity: 65,
        sku: "ELEC-LEDST",
        description: "RGB LED strip with app control",
      },
      {
      ...
      },
      {
        ...
        quantity: 55,
        sku: "ELEC-BT4PK",
        description: "Item tracker compatible with Find My",
      },
      {
      ...
      },
      {
        ...
        quantity: 45,
        sku: "ELEC-SPRG8",
        description: "Power strip with surge protection",
      },
    ];
    ...
    const clothingProducts: Omit<NewProduct, "storeId">[] = [
      ...
      },
      {
        ...
        quantity: 20,
        sku: "CLTH-BLZNVY",
        description: "Classic wool blend blazer",
      },
      {
        name: "Leather Jacket",
        category: "Clothing",
      ...
      },
      {
        ...
        quantity: 30,
        sku: "CLTH-SLKBLS",
        description: "Elegant silk button-up blouse",
      },
      {
        ...
        quantity: 25,
        sku: "CLTH-CSHSW",
        description: "Soft cashmere pullover sweater",
      },
      {
      ...
      },
      {
        ...
        quantity: 18,
        sku: "CLTH-DWNJK",
        description: "Insulated down puffer jacket",
      },
      {
      ...
      },
      {
        ...
        quantity: 35,
        sku: "CLTH-DRSWHT",
        description: "Formal cotton dress shirt",
      },
      {
        name: "Linen Pants",
        category: "Clothing",
      ...
      },
      {
        ...
        quantity: 22,
        sku: "CLTH-MXDFLR",
        description: "Long floral print dress",
      },
      {
      ...
      },
      {
        ...
        quantity: 26,
        sku: "CLTH-CRDKNT",
        description: "Button-front knit cardigan",
      },
      {
        name: "Pleated Skirt",
        category: "Clothing",
        ...
        quantity: 30,
        sku: "CLTH-PLTSKRT",
        description: "A-line pleated midi skirt",
      },
      {
      ...
      },
      {
        ...
        quantity: 65,
        sku: "CLTH-BNCHR",
        description: "Knit winter beanie",
      },
      {
    ...
    const foodProducts: Omit<NewProduct, "storeId">[] = [
      ...
      },
      {
        ...
        quantity: 40,
        sku: "FOOD-GFBEEF",
        description: "1lb grass-fed ground beef",
      },
      {
      ...
      },
      {
        ...
        quantity: 50,
        sku: "FOOD-ORGCHK",
        description: "1lb organic chicken breast",
      },
      {
      ...
      },
      {
        ...
        quantity: 60,
        sku: "FOOD-CHDR",
        description: "Sharp aged cheddar 8oz",
      },
      {
      ...
      },
      {
        ...
        quantity: 70,
        sku: "FOOD-CHTOM",
        description: "Sweet cherry tomatoes pint",
      },
      {
        name: "Mixed Berries",
        category: "Food",
        ...
        quantity: 45,
        sku: "FOOD-MXBER",
        description: "Fresh mixed berries 12oz",
      },
      {
        name: "Organic Honey",
        category: "Food",
      ...
      },
      {
        ...
        quantity: 85,
        sku: "FOOD-PSTPN",
        description: "Italian penne pasta 1lb",
      },
      {
        name: "Marinara Sauce",
        category: "Food",
        ...
        quantity: 70,
        sku: "FOOD-MRNSAUCE",
        description: "Traditional marinara 24oz",
      },
      {
        ...
        quantity: 65,
        sku: "FOOD-PNTBTR",
        description: "No-stir natural peanut butter",
      },
      {
        ...
        quantity: 90,
        sku: "FOOD-DKCHOC",
        description: "72% dark chocolate 3.5oz",
      },
      {
        name: "Trail Mix",
        category: "Food",
        ...
        quantity: 55,
        sku: "FOOD-TRLMX",
        description: "Premium nut and fruit mix",
      },
      {
        ...
        quantity: 80,
        sku: "FOOD-SPKWTR",
        description: "Unflavored sparkling water",
      },
      {
        ...
        quantity: 50,
        sku: "FOOD-CLDBREW",
        description: "Ready-to-drink cold brew 32oz",
      },
      {
      ...
      },
      {
        ...
        quantity: 55,
        sku: "FOOD-HMMUS",
        description: "Classic hummus 10oz",
      },
      {
        name: "Tortilla Chips",
        category: "Food",
        ...
        quantity: 75,
        sku: "FOOD-TRTCHP",
        description: "Stone-ground corn chips",
      },
      {
        name: "Salsa Verde",
        category: "Food",
        ...
        quantity: 50,
        sku: "FOOD-SLSVRD",
        description: "Authentic green salsa 16oz",
      },
      {
        name: "Coconut Oil",
        category: "Food",
      ...
      },
      {
        ...
        quantity: 0,
        sku: "FOOD-OTMLKBR",
        description: "Barista-style oat milk - OUT OF STOCK",
      },
      {
        name: "Almond Butter",
        category: "Food",
        ...
        quantity: 3,
        sku: "FOOD-ALMBT",
        description: "Creamy almond butter - LOW STOCK",
      },
      {
        name: "Chia Seeds",
        category: "Food",
        ...
        quantity: 2,
        sku: "FOOD-CHISD",
        description: "Organic chia seeds - LOW STOCK",
      },
    ];
    ...
    const electronicsWithStoreId: NewProduct[] = electronicsProducts.map(
      (p) => ({
        ...p,
